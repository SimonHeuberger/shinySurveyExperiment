...
#### Code before I massively starting changing things so that I wouldn't have to change the names and cases hundreds of times ####
...
# This needs to be run after createPageList. Otherwise idsVec contains the name of the original .txt, not the name of the created page list, and that causes an error in createCtrlList
